...
## 📄 ساختار API
برای مشاهده لیست کامل مسیرهای API، پارامترها و نمونه پاسخ‌ها، لطفاً به فایل [**API_DOCS.md**](API_DOCS.md) در همین ریپازیتوری مراجعه کنید.
*(**نکته:** فایل Markdown مستندات API که قبلاً ساختیم را اینجا قرار دهید)*
